...
<div class="account-header-wrapper order-history subscription-history">
    <section class="account-header sales_order_details">
        <h2><?php echo __('My Subscription', 'storefrontchild'); ?></h2>
    </section>
</div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-7 col-xl-6">
                <div class="account-intro-main">
                    <h3><?php echo __('View Subscription', 'storefrontchild'); ?></h3>
                </div>
            </div>
        </div>
    </div>
...
<table class="shop_table subscription_details" style="margin-top:30px;">
	<tbody>
		<tr>
