                        ...
                        <tbody>
                           <tr>
                              <td class="header" style="background-color: #08456b; color: #ffffff; font-family: Raleway, sans-serif;">
                                 <h1 style="color:#ffffff; font-size:30px; font-weight:300; line-height:150%; margin:0; text-align:center; padding: 2rem 0;">Thank you for your order</h1>
                              </td>
                           </tr>
                        </tbody>
                     </table>
                     <table width="100%" style="max-width: 600px; text-align: center; background: #fff;">
                        <tr>
                           <td>
                                ...
                                <p style="text-align: left;"><?php printf( esc_html__( 'Just to let you know &mdash; we\'ve received your subscription renewal order #%s, and it is now being processed:', 'woocommerce-subscriptions' ), esc_html( $order->get_order_number() ) ); ?></p>
                                                                <br/>
                                <?php
