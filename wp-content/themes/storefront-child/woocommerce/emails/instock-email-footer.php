...
?>
                                            <table width="100%" cellpadding="0" align="center">
                                                        <tr>
                                                            <td style="margin-bottom: 2.5rem;text-transform: uppercase;font-family: Helvetica, Arial, sans-serif !important;font-weight: bold;padding: 15px;width: 450px;margin: 0 auto;background-color: #00b1aa;text-align: center;border-radius: 5px">
                                                                <a style="color: #ffffff;text-decoration: none; font-weight: bold !important;" href="<?php echo esc_url( home_url( '/' ) ); ?>" target="_blank">SHOP NOW</a>
                                                            </td>
                                                        </tr>
                                            </table>
                                            <?php
                                            ...
                                            if (!$user->exists() ) {
                                            ?>
                                                <p style="font-family: Helvetica, Arial, sans-serif !important;font-size: 14px;color: #878787;font-weight: bold;text-align: left;margin-top: 20px">Create an account with us to help make your next order easier and quicker: </p>
                                                <br>
                                                <table width="100%" cellpadding="0" align="center">
                                                            <tr>
                                                                <td style="margin-bottom: 20px !important;text-transform: uppercase;font-family: Helvetica, Arial, sans-serif !important;font-weight: bold;padding: 15px;width: 450px;margin: 0 auto;background-color: #00b1aa;text-align: center;border-radius: 5px">
                                                                    <a style="color: #ffffff;font-weight: bold !important;text-decoration: none" href="<?php echo esc_url( home_url( '/register' ) ); ?>" target="_blank"> CREATE AN ACCOUNT </a>
                                                                </td>
                                                            </tr>
                                                </table>
                                            <?php } ?>
                        ...
                        <table width="100%" style="margin-top:20px; max-width: 600px;background: #fff;font-family: Helvetica, Arial, sans-serif !important">
                            <tr>
