...
<div style="width: 100%">
    <table class="wrapper" width="100%">
        <tr>
            <td class="wrapper-inner" align="center" style="padding: 25px 0">
                    ...
                    <tr>
                        <td class="main-content">
                                <table width="100%" style="max-width: 600px;background:#fff">
                                                          ...
                                                          <table width="100%" cellpadding="25px">
                                                              <tr>
                                                                  <td width="100%" style="padding:0px">
                                                                     <img src="<?php echo $images['out-of-stock'] ?>">
                                                                  </td>
                                                               </tr>
                                                          ...
                                                          <table width="100%" cellpadding="25px" style="background:                                                                #fff">
                                                               <tr style="background: #fff;padding: 0 20px">
                                                                  <td style="text-align: left">
                                                                      <a target="_blank" href="<?php echo esc_url( home_url( '/faqs' ) ); ?>" style="text-align: center;padding-left: 25px;color: #878787;font-size: 14px;font-family: Helvetica, Arial, sans-serif !important;margin: 0;text-transform: uppercase;text-decoration: none !important">
                                                                          FAQs</a>
                                                                  </td>
                                   ...
                                   <tr>
                                        <td style="padding: 10px 25px 0;background-color: white">
