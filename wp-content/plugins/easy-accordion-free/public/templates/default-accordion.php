...
foreach ( $content_sources as $key => $content_source ) {
	...
	echo '<div class="ea-card panel-heading ' . esc_attr( $expand_class . ' ' . $accordion_item_class ) . '">';
		echo sprintf(
			'<h4 class="ea-header panel-title">
				<a class="collapsed" data-sptoggle="spcollapse" %1$s href="javascript:void(0)" %5$s aria-expanded="%4$s">
