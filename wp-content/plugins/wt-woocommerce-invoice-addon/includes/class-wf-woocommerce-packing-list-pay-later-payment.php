...
if((!class_exists('Wf_Woocommerce_Packing_List_Pay_Later_Payment')) && (class_exists('WC_Payment_Gateway')))
{
	class Wf_Woocommerce_Packing_List_Pay_Later_Payment extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->method_description = __( 'Allows a ‘Pay Later’ option at the checkout. Orders will be marked with the status ‘On hold’ on using this payment method.', 'wt_woocommerce_invoice_addon' );
