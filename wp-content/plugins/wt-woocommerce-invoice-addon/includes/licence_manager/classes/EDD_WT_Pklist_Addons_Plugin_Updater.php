...
namespace Wf_Woocommerce_Packing_List\Licence_Manager;
 ...
 * @version 1.9.2
 */
if ( !class_exists( 'EDD_WT_Pklist_Addons_Plugin_Updater' ) ) {
	class EDD_WT_Pklist_Addons_Plugin_Updater {
		...
		public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
			...
			$this->failed_request_cache_key = 'edd_wt_pklist_failed_http_' . md5( $this->api_url );
			 ...
			 */
			do_action( 'post_edd_wt_pklist_plugin_updater_setup', $edd_plugin_data );
		...
		public function show_update_notification( $file, $plugin ) {
			...
			if ( ! empty( $update_cache->response[ $this->name ]->sections->changelog ) ) {
				$changelog_link = add_query_arg(
					array(
						'edd_wt_pklist_addons_action' => 'view_plugin_changelog',
		 ...
		 *
		 * @see EDD_WT_Pklist_Addons_Plugin_Updater::request_recently_failed
		 *
		 * @since 1.9.1
		 */
		...
		public function show_changelog() {
			...
			if ( empty( $_REQUEST['edd_wt_pklist_addons_action'] ) || 'view_plugin_changelog' !== $_REQUEST['edd_wt_pklist_addons_action'] ) {
				return;
			}
		...
		private function get_version_from_remote() {
			 ...
			 */
			$api_params = apply_filters( 'edd_wt_pklist_addons_plugin_updater_api_params', $api_params, $this->api_data, $this->plugin_file );
		...
		private function verify_ssl() {
			return (bool) apply_filters( 'edd_wt_pklist_addons_api_request_verify_ssl', true, $this );
		}
		...
		private function get_cache_key() {
			...
			return 'edd_wt_pklist_addons_' . md5( serialize( $string ) );
		}
