			...
			if("" !== $th_html)
			{
				...
				foreach($th_html_arr as $th_single_html)
				{
					...
					if("" !== $th_single_html)
					{
						...
						if("tax" === $col_key || "-tax" === $col_key || "tax" === Wf_Woocommerce_Packing_List_Template_Render_IPC::get_column_key($col_key)) //column key is tax then check, tax column options are enabled
						{
