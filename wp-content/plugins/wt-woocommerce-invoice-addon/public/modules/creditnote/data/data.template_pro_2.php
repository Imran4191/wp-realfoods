...
.template_footer{color:#202020; font-size:12px; font-weight:400; box-sizing:border-box; padding:30px 0px; background:transparent; height:auto;}
...
<div class="wfte_rtl_main wfte_invoice-main wfte_adc_main" style="padding:30px; margin:0px; background:#fff;"> 
            ...
            <table class="wfte_payment_summary_table wfte_product_table wfte_side_padding_table">
                <tbody class="wfte_payment_summary_table_body wfte_table_body_color">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_product_table_additional_info wfte_hidden wfte_template_element" data-hover-id="product_table_additional_info" data-row-type="wfte_product_table_additional_info">
                        <td colspan="2"  class="wfte_product_table_additional_info_label wfte_text_left">[wfte_product_table_additional_info_label]</td>
