        ...
        <table class="wf-form-table">
            <?php
                ...
                $settings_arr['creditnote_general_general'] = array(
                    ...
                    'wt_pklist_document_language' => array(
                        'type' => 'multi_language_option',
                        'label' => __("Generate credit note in","wt_woocommerce_invoice_addon"),
                        'id' => '',
                        'class' => 'wt_pklist_document_language',
                        'name' => 'wt_pklist_document_language',
                        'value' => '',
                        'radio_fields' => array(
                            'site'=>__('Site language','wt_woocommerce_invoice_addon'),
                            'customer'=>__('Customer language','wt_woocommerce_invoice_addon'),
                        ),
                        'radio_fields_help_text' => array(
                            'site' => __("In multilingual sites, credit note language may differ from the default one set in WordPress Settings > General > Site Language, depending on customer`s  choice via the site`s language switcher.","wt_woocommerce_invoice_addon"),
                            'customer' => __("To generate a credit note in the customer`s language, ensure that the plugin has the corresponding language file for the selected language. If not, add it to use the functionality.","wt_woocommerce_invoice_addon")
                        ),
                        'col' => 3,
                        'tooltip' => true,
                        'alignment' => 'vertical_with_label',
                        'ref_id' => 'wt_pklist_document_language',
                    ),
                ...
                if(version_compare(WF_PKLIST_VERSION,'4.2.0') >= 0){
                    $settings_arr['creditnote_general_creditnote_number']['invoice_number_format'] = array(
                        'type' => 'invoice_number_format',
                    );
                }else{
                    $settings_arr['creditnote_general_creditnote_number']['woocommerce_wf_invoice_as_ordernumber'] = array(
                        'type' => 'wt_radio',
                    ...
                    $settings_arr['creditnote_general_creditnote_number']['woocommerce_wf_invoice_start_number'] = array(
                    ...
                    $settings_arr['creditnote_general_creditnote_number']['woocommerce_wf_invoice_number_format'] = array(
                        'type'=>'wt_select_dropdown',
                    ...
                    $settings_arr['creditnote_general_creditnote_number']['woocommerce_wf_invoice_number_prefix'] = array(
                        'type' => 'wt_text',
                    ...
                    $settings_arr['creditnote_general_creditnote_number']['woocommerce_wf_invoice_number_postfix'] = array(
                        'type' => 'wt_text',
                    ...
                    $settings_arr['creditnote_general_creditnote_number']['woocommerce_wf_invoice_padding_number'] = array(
                        'type'=>'wt_number',
                ...
                $settings_arr['creditnote_general_creditnote_number']['wt_inv_gen_hr_line_3'] = array(
                        'type' => 'wt_hr_line',
                        'class' => 'wf_field_hr',
                        'ref_id' => 'wt_hr_line_4',
                );
                ...
                $settings_arr['creditnote_general_others'] = array(
                    'wt_sub_head_inv_gen_adv' => array(
                        'type' => 'wt_sub_head',
                        'class' => 'wt_pklist_field_group_hd_sub',
                        'label' => __("Others",'wt_woocommerce_invoice_addon'),
                        'heading_number' => 4,
                        'ref_id' => 'wt_sub_head_3'
                    ),
                    'woocommerce_wf_custom_pdf_name' => array(
                        'type' => 'wt_select_dropdown',
                        'label' => __("PDF name format","wt_woocommerce_invoice_addon"),
                        'id' => "",
                        'name' => "woocommerce_wf_custom_pdf_name",
                        'value' => "",
                        'select_dropdown_fields' => array(
                                '[prefix][order_no]'=>__('[prefix][order_no]', 'wt_woocommerce_invoice_addon'),
                                '[prefix][invoice_no]'=>__('[prefix][creditnote_no]', 'wt_woocommerce_invoice_addon'),
                            ),
                        'class' => "",
                        'col' => 3,
                        'help_text' => __("Select a name format for PDF credit note that includes credit note number/order number.","wt_woocommerce_invoice_addon"),
                        'ref_id' => 'woocommerce_wf_custom_pdf_name',
                        'style' => 'width:300px;',
                    ),
                    'woocommerce_wf_custom_pdf_name_prefix' => array(
                        'type' => "wt_text",
                        'label' => __("Custom PDF name prefix", 'wt_woocommerce_invoice_addon'),
                        'name' => 'woocommerce_wf_custom_pdf_name_prefix',
                        'help_text'=>__("Input a custom prefix for `PDF name format` that will appear at the beginning of the name. Defaulted to `Creditnote_`.",'wt_woocommerce_invoice_addon'),
