...
$settings["packingslip_general_general"] = array(
    ...
    'wt_pklist_document_language' => array(
        ...
        'label' => __("Generate packing slip in","wt_woocommerce_invoice_addon"),
        'id' => '',
        ...
        'radio_fields' => array(
            ...
            'current_user'=> __('Current user profile language','wt_woocommerce_invoice_addon'),
        ),
        'radio_fields_help_text' => array(
            'site'=> __("In multilingual sites, packing slip language may differ from the default one set in WordPress Settings > General > Site Language, depending on customer`s  choice via the site`s language switcher.","wt_woocommerce_invoice_addon"),
            'customer'=> __("To generate a packing slip in the customer`s language, ensure that the plugin has the corresponding language file for the selected language. If not, add it to use the functionality.","wt_woocommerce_invoice_addon"),
            'current_user'=> __("Current user profile language can vary with users and can be configured under WordPress Users > All Users > User edit page.","wt_woocommerce_invoice_addon")
        ),
        'col' => 3,
        'tooltip' => true,
        'alignment' => 'vertical_with_label',
...
$settings['packingslip_general_product_display'] = array(
    ...
    'wt_pklist_skip_vitual_backorder_items' => array(
        'type' => 'wt_multi_checkbox',
        'label' => __("Skip displaying","wt_woocommerce_invoice_addon"),
        'id' => '',
        'class' => 'wt_pklist_skip_vitual_backorder_items',
        'name' => 'wt_pklist_skip_vitual_backorder_items',
        'value' => '',
        'checkbox_fields' => array(
            'backorder_items' => __('Back order items', 'wt_woocommerce_invoice_addon'),
            'virtual_items' => __('Virtual items','wt_woocommerce_invoice_addon'),
        ),
        'col' => 3,
        'alignment' => 'vertical_with_label',
        'tooltip' => true,
