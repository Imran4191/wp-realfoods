...
$new_arr=array(
	...
	'wf_packinglist_product_meta_fields'=>__("Include custom product meta by clicking on the Add/ Edit product meta field. Key in the field name and meta key to include a product meta. Previously added tab lists the product meta fields added in the past.","wt_woocommerce_invoice_addon"),
	'wt_packinglist_product_attribute_fields'=>__("Include custom product attributes by clicking on the Add/ Edit product attribute field. Key in the field name and meta key to include a product attribute. Previously added tab lists the product attributes added in the past.","wt_woocommerce_invoice_addon"),
	...
	'wt_pklist_document_language' => __("Choose the language for packing slip generation","wt_woocommerce_invoice_addon"),
);
