...
.wfte_product_table_head th{ height:36px; padding:0px 5px; font-size:.75rem; text-align:left; line-height:10px; font-family:"Helvetica Neue", Roboto, Arial, "Droid Sans", sans-serif; text-transform:uppercase;}
.wfte_product_table_body td, .wfte_payment_summary_table_body td{ font-size:12px; line-height:15px;}
.wfte_product_table_body td{ padding:15px 5px 5px 5px; border-bottom:solid 1px #dddee0; text-align:left; vertical-align: top;}
...
<div class="wfte_rtl_main wfte_invoice-main wfte_adc_main" style="padding-top:30px; padding-right:30px; padding-bottom:30px; padding-left:30px; margin-top: 0px; margin-bottom:0px; margin-left:0px; margin-right:0px;">
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">
        ...
        <div class="wfte_col-3 float_right">
            <div class="wfte_qrcode float_right wfte_text_right wfte_template_element wfte_hidden" data-hover-id="qrcode">
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">
        <div class="wfte_addrss_field_main clearfix">
            ...
            <div class="wfte_col-3 float_right">
                <div class="wfte_shipping_address wfte_hidden wfte_template_element" data-hover-id="shipping_address">
        ...
        <div class="wfte_col-1">
            ...
            <table class="wfte_payment_summary_table wfte_product_table">
                <tbody class="wfte_payment_summary_table_body wfte_table_body_color">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_hidden wfte_product_table_cart_discount wfte_template_element" data-hover-id="product_table_cart_discount" data-row-type="wfte_product_table_cart_discount" data-tax-type="<?php esc_attr_e($all_attr['tax_type']); ?>">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_hidden wfte_product_table_order_discount wfte_template_element" data-hover-id="product_table_order_discount" data-row-type="wfte_product_table_order_discount" data-tax-type="<?php esc_attr_e($all_attr['tax_type']); ?>">
                    ...
                    <tr data-row-type="wfte_tax_items" class="wfte_payment_summary_table_row wfte_hidden wfte_product_table_tax_item wfte_template_element" data-hover-id="product_table_tax_item" data-ind-tax-type="tot-combined-tax">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_hidden wfte_product_table_fee wfte_template_element" data-hover-id="product_table_fee" data-row-type="wfte_product_table_fee" data-tax-type="<?php esc_attr_e($all_attr['tax_type']); ?>">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_product_table_additional_info wfte_hidden wfte_template_element" data-hover-id="product_table_additional_info" data-row-type="wfte_product_table_additional_info">
                        ...
                        <td class="wfte_product_table_additional_info_label wfte_text_right">[wfte_product_table_additional_info_label]</td>
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix" style="margin-top:20px;">
        ...
        <div class="wfte_col-4 float_right">
            <div class="wfte_signature wfte_template_element wfte_hidden" data-hover-id="signature">
    ...
    <div class="wfte_row wfte_adc_row wfte_padding_left_right clearfix">
        <div class="wfte_col-1">
            <div class="wfte_barcode wfte_hidden float_right wfte_text_right wfte_template_element" data-hover-id="barcode">
