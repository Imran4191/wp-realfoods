...
class Wt_Pklist_Common_Ipc
{
    ...
    public static $modules = array(
        'wt_wc_order_item_product',
        'wt_pklist_language_switcher'
    );
    ...
    /**
     * To get order meta value
     * @since 1.0.4 - [Fix] - Get meta value, if even ACF is active
     * 1.0.4 - [Fix] - Compatibility error with kadence email customizer plugin, as it sends the order as null value
     * @param object|int|string $order
    ...
    {    
        ...
        {
            return wp_kses_post(isset(self::$default_meta_values[$meta_key]) ? self::$default_meta_values[$meta_key] : '');
        }
        $meta_value = '';
    ...
    public static function is_dokan_plugin_active()
    {
