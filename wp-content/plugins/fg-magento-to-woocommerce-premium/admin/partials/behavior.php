				...
				<tr>
					...
					<div id="media_import_box">
						...
						<br />
						<input id="first_image_in_gallery" name="first_image_in_gallery" type="checkbox" value="1" <?php checked($data['first_image_in_gallery'], 1); ?> /> <label for="first_image_in_gallery"><?php _e("Import the first image into the product gallery", 'fg-magento-to-woocommerce'); ?></label>
						<br />
						<input id="thumbnail_in_gallery" name="thumbnail_in_gallery" type="checkbox" value="1" <?php checked($data['thumbnail_in_gallery'], 1); ?> /> <label for="thumbnail_in_gallery"><?php _e("Import the product thumbnail into the product gallery", 'fg-magento-to-woocommerce'); ?></label>
						<br />
