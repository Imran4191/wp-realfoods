...
document.addEventListener('DOMContentLoaded', function() {
  ...
  setupButtons.forEach(function(button) {
    button.addEventListener('click', function() {
      ...
      xhr.open('POST', DFWAjax.ajaxurl, true);
      ...
      xhr.send('action=DFWbridge_action&connector_action=' + install + 'Bridge');
    });
  });
  ...
  updateBridgeStoreKey.addEventListener('click', function() {
    ...
    xhr.send('action=DFWbridge_action&connector_action=updateToken');
  });
